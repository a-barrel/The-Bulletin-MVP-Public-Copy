...
import { isTeleportLockedForUser, isAnyTeleportLocked, clearTeleportLockForUser } from '../utils/mapTeleportSession';
...
function ListPage() {
  ...
  const teleportLocked = isTeleportLockedForUser(teleportLockUid) || isAnyTeleportLocked();

  const shouldAutoRefreshLocation =
    !isOffline && !isAdminViewer && !isLoadingViewerProfile && !teleportLocked && !authLoading;
