  ...
  return (
    <Stack
      ...
      sx={{
        ...
        backgroundColor: 'var(--color-surface-wash, #ECF8FE)',
        borderRadius: 3,
      ...
      >
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
          <Button
            ...
            size="small"
            disabled={isSaving}
            sx={{ borderWidth: 2, borderColor: 'var(--color-border-strong, #000)', color: 'var(--color-text-strong, #000)' }}
          >
            Upload banner
          ...
          <Button
            ...
            sx={{ color: 'var(--accent-strong, #5D3889)' }}
          >
            Remove banner
          </Button>
        </Stack>
